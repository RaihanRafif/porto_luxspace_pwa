...
async function subscribe() {
    const key = "BM9CLj1qmv4L8K2ToQLMyPA3bYzQOddF2NNjIwxeiQ4Z8lXDa_p2wCpZzRXmESKK4RW1owC76BEv_u0RX0ytW4o";
    try {
                ...
                <div className="container mx-auto min-h-screen">
                    <div className="flex flex-col items-center justify-center">
                        <div className="w-full md:w-4/12 text-center">
                            ...
                            <h2 className="text-xl font-semibold mb-1">Raihan Rafif</h2>
                            <p className="text-lg mb-12">Fullstack Website Developer</p>
                        </div>
                    </div>
